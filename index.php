<?php
  ...
  $email = "jonny@list.ru";
  $phone = "+7 (952) 455 - 69 - 75";
  $skills = [
 	 ["name" => "Photoshop", "percent" => "45%"],
     ["name" => "Photo", "percent" => "75%"],
     ["name" => "Image", "percent" => "90%"],
     ["name" => "Sound", "percent" => "15%"],
  ];
  $firstYear = 1987;
  $currentYear = 2022;
  $age = $currentYear - $firstYear;
  $telegram = "@KvShef";
  
  $experience = [
  	["name" => "Front End Developer",
    "date" => 'Okt 2020 - <span class="w3-tag w3-teal w3-round">Current</span>',
    ...
    <div class="w3-third">
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-battery-three-quarters fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $age; ?></p>
          <p><i class="fa fa-telegram fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $telegram; ?></p>
          <hr>
        ...
        <?php for($i = 0; $i < count($experience); $i++) : ?>
         <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
            <?php echo $experience[$i]["date"]; ?></h6>
          <p><?php echo $experience[$i]["description"];
					if ($i < (count($experience) - 1)) echo "<hr>"; ?></p>
        </div>
        <?php endfor; ?>
      </div>
